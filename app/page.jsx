...
const HomePage = () => {
  return (
    <div className="min-h-screen items-center justify-center text-white text-center relative pt-20">
      <div className="max-w-screen-xl mx-auto p-8">
        ...
        <Link href="/auth" className=" border border-#E0AAFF rounded-full bg-pink-300  hover:bg-blue-600 text-primary font-textFont font-bold py-3 px-6 md:py-4 md:px-8 mt-4 md:mt-8 w-1/2">
