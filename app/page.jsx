...
const HomePage = () => {
  return (
    <div className="w-3/4 m-auto min-h-screen items-center justify-center text-center relative pt-20 ">
      <div className="max-w-screen-xl mx-auto p-8 lg:flex">
        ...
        <div className="lg:w-1/2">
          <div className="text-3xl font-titleFont text-left pt-10 lg:pt-0">
